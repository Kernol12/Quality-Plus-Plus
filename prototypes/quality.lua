...
local quality_defs = {
	mythical = {
		...
		subgroup = "qualities",
		icon = "__private-quality-plus-plus__/graphics/icons/quality-mythical.png",
	...
	masterwork = {
		...
		next_probability = 0.1,
		subgroup = "qualities",
		icon = "__private-quality-plus-plus__/graphics/icons/quality-masterwork.png",
	...
	wondrous = {
		...
		next_probability = 0.1,
		subgroup = "qualities",
		icon = "__private-quality-plus-plus__/graphics/icons/quality-wondrous.png",
	...
	artifactual = {
		...
		subgroup = "qualities",
		icon = "__private-quality-plus-plus__/graphics/icons/quality-artifactual.png",
